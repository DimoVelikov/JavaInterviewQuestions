...
public class HTTP {
    public static void main(String[] args) {
        ...
        String result = (code == 200)? "Ok" :(code== 201)? "Created" :(code==202)? "Accepted"
                ...
                :(code== 403)? "Forbidden" :(code==404)? "Not Found" :(code==410)? "Gone":(code==500)?
                "Internal Server Error" :(code==503)? "Service Unavailable" :"invalid input";

        System.out.println("Code status: " + result);
